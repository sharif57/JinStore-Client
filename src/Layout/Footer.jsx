const Footer = () => {
    return <div  className="bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 mt-10">
        <footer className=" container mx-auto py-14 px-16 font-sans tracking-wide relative">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div>
                    <h2 className="text-white text-lg font-semibold mb-4">Quick Links</h2>
                    <ul className="space-y-4">
                        <li>
                            <a href="#" className="text-gray-300 hover:text-white text-sm transition-all">Newsroom</a>
                        </li>
                        <li>
                            <a href="#" className="text-gray-300 hover:text-white text-sm transition-all">Tailwind CSS</a>
                        </li>
                        <li>
                ...
                <div className="flex items-center lg:justify-center">
                    <a href="#"><img src="\Group 70.png" alt="logo" className="w-60" /></a>
                </div>
            </div>
